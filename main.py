...
def getSpinBasis(numberOfElectrons, numberOfPositiveSpins, numberOfHoles, electronNumberArray):
	...
	resultLen = special.comb(numberOfHoles, numberOfElectrons, exact=True) * special.comb(numberOfElectrons, numberOfPositiveSpins, exact=True)
...
electronNumberArray = assignNumberToElectronNumber(numberOfHoles)

print(electronNumberArray)

spinlessBasis = getSpinlessBasis(numberOfElectrons, numberOfHoles, electronNumberArray)

print(spinlessBasis)

spinBasis = getSpinBasis(numberOfElectrons, numberOfPositiveSpins, numberOfHoles, electronNumberArray)
